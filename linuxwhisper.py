...
try:
    ...
    print("Warning: hotkeys.py not found. Using defaults.")
    import types
    hotkeys = types.SimpleNamespace()
    hotkeys.DICTATION = keyboard.Key.f3
...
class KeyboardHandler:
    ...
    KEY_MAPPINGS: Dict[str, List[Any]] = {
        "f3": [hotkeys.DICTATION, hotkeys.DICTATION_ALT],
